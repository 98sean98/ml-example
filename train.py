...
# os.environ["MLFLOW_TRACKING_USERNAME"] = "98sean98/Deploifai/full-k8-2"
# os.environ["MLFLOW_TRACKING_PASSWORD"] = ""

# setup mlflow for this experiment
# mlflow.set_tracking_uri('https://easy-ducks-sink-20-232-121-159.loca.lt')
# mlflow.set_experiment("98sean98/Deploifai/experiment-1")
...
def main(log_metric, log_param):
    ...
    # test the model using 100 random samples from the training dataset
